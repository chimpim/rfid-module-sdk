...
class JniReader implements Reader {
    ...
    public READER_ERR InitReader(String src, Reader_Type rtype) {
        int re = JniModuleAPI.INSTANCE.InitReader(hReader, src, rtype.value());
    ...
    public READER_ERR InitReader_Notype(String src, int rtype) {
        int re = JniModuleAPI.INSTANCE.InitReader_Notype(hReader, src, rtype);
        READER_ERR ERR = READER_ERR.valueOf(re);
        return ERR;
    }
    ...
    public void CloseReader() {
        JniModuleAPI.INSTANCE.CloseReader(hReader[0]);
    }

    @Override
    public READER_ERR GetTagData(int ant, char bank, int address,
                                 int blkcnt, byte[] data, byte[] accesspasswd, short timeout) {
        int re = JniModuleAPI.INSTANCE.GetTagData(hReader[0], ant, bank, address, blkcnt, data, accesspasswd, timeout);
        READER_ERR ERR = READER_ERR.valueOf(re);
        return ERR;
    }
    ...
    public READER_ERR WriteTagData(int ant, char bank, int address,
        ...
        int re = JniModuleAPI.INSTANCE.WriteTagData(hReader[0], ant, bank, address, data, datalen, accesspasswd, timeout);
        READER_ERR ERR = READER_ERR.valueOf(re);
        return ERR;
    }
    ...
    public READER_ERR WriteTagEpcEx(int ant, byte[] Epc,
        ...
        int re = JniModuleAPI.INSTANCE.WriteTagEpcEx(hReader[0], ant, Epc, epclen, accesspwd, timeout);
        READER_ERR ERR = READER_ERR.valueOf(re);
        return ERR;
    }
    ...
    public READER_ERR TagInventory(int[] ants, int antcnt, short timeout,
        ...
        int re = JniModuleAPI.INSTANCE.TagInventory_Raw(hReader[0], ants, antcnt, timeout, tagcnt);
        READER_ERR ERR = READER_ERR.valueOf(re);
    ...
    public READER_ERR TagInventory_BaseType(int[] ants, int antcnt,
        ...
        int re = JniModuleAPI.INSTANCE.TagInventory_BaseType(hReader[0], ants, antcnt, timeout, outbuf, tagcnt);
        READER_ERR ERR = READER_ERR.valueOf(re);
        return ERR;
    }
    ...
    public READER_ERR GetNextTag(TAGINFO TI) {
        ...
        int pos = 0;
        int re = JniModuleAPI.INSTANCE.GetNextTag_BaseType(hReader[0], tagbuf);
        READER_ERR ERR = READER_ERR.valueOf(re);
        //TAGINFO TI;
        if (ERR == READER_ERR.MT_OK_ERR) {
            //TI = new TAGINFO();
    ...
    public READER_ERR GetNextTag_BaseType(byte[] outbuf) {
        int re = JniModuleAPI.INSTANCE.GetNextTag_BaseType(hReader[0], outbuf);
        READER_ERR ERR = READER_ERR.valueOf(re);
        return ERR;
    }
    ...
    public READER_ERR LockTag(int ant, byte lockobjects, short locktypes,
        ...
        int re = JniModuleAPI.INSTANCE.LockTag(hReader[0], ant, lockobjects, locktypes, accesspasswd, timeout);
        READER_ERR ERR = READER_ERR.valueOf(re);
        return ERR;
    }
    ...
    public READER_ERR KillTag(int ant, byte[] killpasswd, short timeout) {
        int re = JniModuleAPI.INSTANCE.KillTag(hReader[0], ant, killpasswd, timeout);
        READER_ERR ERR = READER_ERR.valueOf(re);
        return ERR;
    }
    ...
    public READER_ERR Lock180006BTag(int ant, int startblk, int blkcnt,
                                     short timeout) {
        int re = JniModuleAPI.INSTANCE.Lock180006BTag(hReader[0], ant, startblk, blkcnt, timeout);
        READER_ERR ERR = READER_ERR.valueOf(re);
        return ERR;
    }
    ...
    public READER_ERR BlockPermaLock(int ant, int readlock, int startblk,
        ...
        int re = JniModuleAPI.INSTANCE.BlockPermaLock(hReader[0], ant, readlock, startblk, blkrange, mask, pwd, timeout);
        READER_ERR ERR = READER_ERR.valueOf(re);
        return ERR;
    }
    ...
    public READER_ERR BlockErase(int ant, int bank, int wordaddr, int wordcnt,
        ...
        int re = JniModuleAPI.INSTANCE.BlockErase(hReader[0], ant, bank, wordaddr, wordcnt, pwd, timeout);
        READER_ERR ERR = READER_ERR.valueOf(re);
        return ERR;
    }
    ...
    public READER_ERR EraseDataOnReader() {
        int re = JniModuleAPI.INSTANCE.EraseDataOnReader(hReader[0]);
        READER_ERR ERR = READER_ERR.valueOf(re);
        return ERR;
    }
    ...
    public READER_ERR SaveDataOnReader(int address, byte[] data, int datalen) {
        int re = JniModuleAPI.INSTANCE.SaveDataOnReader(hReader[0], address, data, datalen);
        READER_ERR ERR = READER_ERR.valueOf(re);
        return ERR;
    }
    ...
    public READER_ERR ReadDataOnReader(int address, byte[] data, int datalen) {
        int re = JniModuleAPI.INSTANCE.ReadDataOnReader(hReader[0], address, data, datalen);
        READER_ERR ERR = READER_ERR.valueOf(re);
        return ERR;
    }
    ...
    public READER_ERR CustomCmd(int ant, CustomCmdType cmdtype, Object CustomPara, Object CustomRet) {
        ...
        int re = JniModuleAPI.INSTANCE.CustomCmd_BaseType(hReader[0], ant, cmdtype.ordinal(), para, ret);
        READER_ERR ERR = READER_ERR.valueOf(re);
    ...
    public READER_ERR CustomCmd_BaseType(int ant, int cmdtype, byte[] CustomPara, byte[] CustomRet) {
        int re = JniModuleAPI.INSTANCE.CustomCmd_BaseType(hReader[0], ant, cmdtype, CustomPara, CustomRet);
        READER_ERR ERR = READER_ERR.valueOf(re);
        return ERR;
    }
    ...
    public READER_ERR SetGPO(int gpoid, int val) {
        int re = JniModuleAPI.INSTANCE.SetGPO(hReader[0], gpoid, val);
        READER_ERR ERR = READER_ERR.valueOf(re);
        return ERR;
    }
    ...
    public READER_ERR GetGPI(int gpoid, int[] val) {
        int re = JniModuleAPI.INSTANCE.GetGPI(hReader[0], gpoid, val);
        READER_ERR ERR = READER_ERR.valueOf(re);
        return ERR;
    }
    ...
    public READER_ERR PsamTransceiver(int soltid, int coslen, byte[] cos,
        ...
        int re = JniModuleAPI.INSTANCE.PsamTransceiver(hReader[0], soltid, coslen, cos, cosresplen,
    ...
    public READER_ERR ParamGet(Mtr_Param key, Object val) {
        ...
        switch (key) {
            case MTR_PARAM_RF_ANTPOWER: {
                ...
                re = JniModuleAPI.INSTANCE.ParamGet(hReader[0], key.value(), data);
                if (re == 0) {
            ...
            break;
            default:
                re = JniModuleAPI.INSTANCE.ParamGet(hReader[0], key.value(), val);
                break;
        }
    ...
    public READER_ERR ParamSet(Mtr_Param key, Object val) {
        ...
        switch (key) {
            case MTR_PARAM_RF_ANTPOWER: {
                ...
                re = JniModuleAPI.INSTANCE.ParamSet(hReader[0], key.value(), data);
            }
            break;
            case MTR_PARAM_TAG_FILTER: {
                if (val != null) {
                    ...
                    re = JniModuleAPI.INSTANCE.ParamSet(hReader[0], key.value(), null);
                }
            }
            break;
            case MTR_PARAM_TAG_EMBEDEDDATA: {
            ...
            break;
            default:
                re = JniModuleAPI.INSTANCE.ParamSet(hReader[0], key.value(), val);
                break;
        }
